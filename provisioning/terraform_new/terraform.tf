...
resource "aws_s3_bucket" "testing" {
  bucket = "metadata-resources-testing.data.bas.ac.uk"
...
resource "aws_s3_bucket" "production" {
  bucket = "metadata-resources.data.bas.ac.uk"
...
resource "aws_cloudfront_distribution" "testing" {
  enabled     = true
  comment     = "BAS Metadata Standards resources (Testing)"
...
resource "aws_cloudfront_distribution" "production" {
  enabled             = true
  comment             = "BAS Metadata Standards resources"
